...
/** Result returned by parallelBfsCrawl. */
interface BfsCrawlResult {
  urls: string[];
  /** True when crawling was stopped early because the internal deadline was reached. */
  hitDeadline: boolean;
}
