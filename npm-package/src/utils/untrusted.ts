...
export function untrustedOverheadBytes(source: string): number {
 ...
 */
export function wrapUntrustedInline(text: string, source: string): string {
...
export function untrustedInlineOverheadBytes(source: string): number {
...
export function unwrapUntrusted(text: string): string {
  return text
    .replace(MULTILINE_WRAP_RE, (_match, inner: string) => inner)
