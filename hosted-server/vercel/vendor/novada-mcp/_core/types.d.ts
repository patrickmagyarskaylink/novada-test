...
export type BrowserActionType = "navigate" | "click" | "type" | "screenshot" | "snapshot" | "aria_snapshot" | "evaluate" | "wait" | "scroll" | "hover" | "press_key" | "select" | "close_session" | "list_sessions";
