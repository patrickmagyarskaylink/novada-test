 ...
 */
export declare function routeKey(url: string): string | null;
/**
 ...
 */
export declare function getRouteHint(url: string): RouteMode | null;
/**
 ...
 */
export declare function recordRouteSuccess(url: string, mode: string): void;
/**
 ...
 */
export declare function clearRouteMemory(): void;
//# sourceMappingURL=route-memory.d.ts.map