...
export function getApiKey() {
    ...
    if (!key || key.trim() === "") {
        throw makeNovadaError(NovadaErrorCode.INVALID_API_KEY, "NOVADA_API_KEY environment variable is not set.");
    }
    return key.trim();
}
/**
 ...
 */
export function buildProxyUrl(creds, sessionId, country) {
    let user = creds.user;
    if (country)
 ...
 */
export function getBrowserWsUrl() {
