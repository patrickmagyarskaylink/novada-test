...
export declare const YANDEX_OPERATIONS: Readonly<{
    readonly web_search: "yandex";
}>;
...
export declare const YANDEX_SCRAPER_CONFIG: PlatformScraperConfig<YandexOperation>;
/** The materialized Yandex platform-scraper tool (definition + registry entry + handler). */
export declare const YANDEX_SCRAPER_TOOL: {
    toolDefinition: {
        name: string;
        description: string;
...
export declare const ScrapeYandexParamsSchema: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodObject<{
    operation: z.ZodEnum<{
        web_search: "web_search";
    }>;
    params: z.ZodDefault<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
...
export declare function validateScrapeYandexParams(args: Record<string, unknown> | undefined): ScrapeYandexParams;
/**
 ...
 * duplicated here.
 */
export declare function novadaScrapeYandex(params: ScrapeYandexParams, apiKey: string): Promise<string>;
//# sourceMappingURL=scrape_yandex.d.ts.map