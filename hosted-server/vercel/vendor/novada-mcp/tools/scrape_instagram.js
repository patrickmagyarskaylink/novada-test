...
const INSTAGRAM_OPERATION_PARAMS_DOC = {
...
const INSTAGRAM_OPERATION_CONFIGS = Object.fromEntries(Object.keys(INSTAGRAM_OPERATIONS).map((name) => [
    name,
...
export const INSTAGRAM_SCRAPER_CONFIG = {
    ...
    registryDescription: "Extract structured Instagram data (profiles, posts, reels, comments) via a closed, typed operation enum — 7 verified-working operations; same engine and output formats as novada_scrape, pinned to platform=instagram.com",
    operations: INSTAGRAM_OPERATION_CONFIGS,
    paramsFieldDoc: "Operation-specific parameters for the selected `operation`. E.g. { posturl: \"https://www.instagram.com/p/...\" } for " +
...
export function validateScrapeInstagramParams(args) {
 ...
 * duplicated here.
 */
export async function novadaScrapeInstagram(params, apiKey) {
    return INSTAGRAM_SCRAPER_TOOL.handler(params, apiKey);
}
//# sourceMappingURL=scrape_instagram.js.map