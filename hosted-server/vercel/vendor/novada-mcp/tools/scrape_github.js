...
const GITHUB_OPERATION_PARAMS_DOC = {
...
const GITHUB_OPERATION_CONFIGS = Object.fromEntries(Object.keys(GITHUB_OPERATIONS).map((name) => [
    name,
...
export const GITHUB_SCRAPER_CONFIG = {
    platform: "github.com",
    platformLabel: "GitHub",
    toolName: "novada_scrape_github",
    category: "Scraping & Verification",
    registryDescription: "Extract structured GitHub repository data (by repository URL or a search-results URL) via a closed, typed operation enum — 3 verified-working operations; same engine and output formats as novada_scrape, pinned to platform=github.com",
...
export function validateScrapeGithubParams(args) {
 ...
 * duplicated here.
 */
export async function novadaScrapeGithub(params, apiKey) {
    return GITHUB_SCRAPER_TOOL.handler(params, apiKey);
}
//# sourceMappingURL=scrape_github.js.map